...
project set family "CYCLONEIII"
project set device EP3C25
project set speed -8
project set package FC324
...
lib_vhdl new gsi
lib_vhdl new work
xfile add "../../boards/altera-ep3c25-eek/leon3mp.ucf"
xfile add "config.vhd" -lib_vhdl work
puts "config.vhd"
xfile add "ahbrom.vhd" -lib_vhdl work
puts "ahbrom.vhd"
xfile add "serializer.vhd" -lib_vhdl work
puts "serializer.vhd"
xfile add "altera_eek_clkgen.vhd" -lib_vhdl work
puts "altera_eek_clkgen.vhd"
...
project set "Macro Search Path" "../../netlists/xilinx/CYCLONEIII" -process "Translate"
