...
#if defined(CONFIG_LEON) && (CONFIG_PAGE_SIZE_LEON == 1)
#define ELF_EXEC_PAGESIZE	(4096*2)
#elif defined(CONFIG_LEON) && (CONFIG_PAGE_SIZE_LEON == 2)
#define ELF_EXEC_PAGESIZE	(4096*4)
#else
#ifndef CONFIG_SUN4
