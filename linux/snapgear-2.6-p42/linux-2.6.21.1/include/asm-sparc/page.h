...
#define PAGE_SHIFT   (PAGE_MIN_SHIFT+CONFIG_PAGE_SIZE_LEON)
#endif
#ifndef __ASSEMBLY__
...
#if defined(CONFIG_LEON) && (CONFIG_PAGE_SIZE_LEON == 2)
typedef struct { unsigned long pmdv[64]; } pmd_t; 
#elif defined(CONFIG_LEON) && (CONFIG_PAGE_SIZE_LEON == 1)
typedef struct { unsigned long pmdv[32]; } pmd_t;
#else
