...
#define SRMMU_REAL_PMD_SHIFT		LEON_PMD_SH
#define SRMMU_REAL_PMD_SIZE		(1UL << SRMMU_REAL_PMD_SHIFT)
#define SRMMU_REAL_PMD_MASK		(~(SRMMU_REAL_PMD_SIZE-1))
#define SRMMU_REAL_PMD_ALIGN(__addr)	(((__addr)+SRMMU_REAL_PMD_SIZE-1)&SRMMU_REAL_PMD_MASK)

/* PGDIR_SHIFT determines what a third-level page table entry can map */
#define SRMMU_PGDIR_SHIFT       LEON_PGD_SH
#define SRMMU_PGDIR_SIZE        (1UL << SRMMU_PGDIR_SHIFT)
#define SRMMU_PGDIR_MASK        (~(SRMMU_PGDIR_SIZE-1))
#define SRMMU_PGDIR_ALIGN(addr) (((addr)+SRMMU_PGDIR_SIZE-1)&SRMMU_PGDIR_MASK)

#define SRMMU_REAL_PTRS_PER_PTE	(1 << (LEON_PMD_SH - LEON_PTE_SH))
#define SRMMU_REAL_PTRS_PER_PMD	(1 << (LEON_PGD_SH - LEON_PMD_SH))
#define SRMMU_PTRS_PER_PGD	(1 << (32 - LEON_PGD_SH))

#define SRMMU_REAL_PTRS_PER_PTE_LEON (SRMMU_REAL_PTRS_PER_PTE)
 ...
 * found in pgtable.h.
 */
#define SRMMU_PTRS_PER_PMD	((SRMMU_REAL_PTE_TABLE_SIZE * SRMMU_REAL_PTRS_PER_PMD) / (PAGE_SIZE))
