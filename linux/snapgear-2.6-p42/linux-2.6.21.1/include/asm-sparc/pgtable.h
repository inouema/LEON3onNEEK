...
#define PMD_SHIFT		(LEON_PMD_SH_V) /* SUN4C_PMD_SHIFT */
...
#define PTRS_PER_PTE    	(PAGE_SIZE/4) /*((1<<(6-CONFIG_PAGE_SIZE_LEON))*16)*/ /*(8*16) for CONFIG_PAGE_SIZE_LEON==3 extra */ /*1024*/
...
/* #if CONFIG_PAGE_SIZE_LEON != 3 || PTRS_PER_PTE != (8*16) */
/* #error experimental code for extra size 3 */
/* #endif */
