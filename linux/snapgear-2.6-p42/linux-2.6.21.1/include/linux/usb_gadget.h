...
//to match the size of the skb frag struct array
#define MAX_USB_REQUEST_FRAGS (65536/PAGE_SIZE + 2)

typedef struct usb_request_frag usb_request_frag_t;

struct usb_request_frag {
    struct page* page;
    __u16 page_offset;
    __u16 size;
    dma_addr_t dma;
...
struct usb_request {
	...
	dma_addr_t		dma;
        ...
        usb_request_frag_t frags[MAX_USB_REQUEST_FRAGS];
