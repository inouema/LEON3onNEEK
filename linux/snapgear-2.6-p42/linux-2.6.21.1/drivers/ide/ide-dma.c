...
#ifdef CONFIG_LEON
/* LEON systems using DMA has the ATACTRL_DMA controller */
#undef CONFIG_ATACTRL_DMA
#define CONFIG_ATACTRL_DMA 
#endif
...
int ide_dma_setup(ide_drive_t *drive)
{
	...
	/* PRD table */
#ifndef CONFIG_ATACTRL_DMA
	if (hwif->mmio)
		writel(hwif->dmatable_dma, (void __iomem *)hwif->dma_prdtable);
	else
		outl(hwif->dmatable_dma, hwif->dma_prdtable);
#else
extern void atac_outl(u32 val, unsigned long port);
	atac_outl(hwif->dmatable_dma, (unsigned long)hwif->dma_prdtable);
#endif
